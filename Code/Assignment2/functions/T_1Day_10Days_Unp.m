function [] = T_1Day_10Days_Unp (a,e,i,OM,om,f,muE,om_E,t0,T,RE,type)

% T_1Day_10Days_Unp.m - plot unperturbed ground track for each time duration. 
%
% PROTOTYPE:
%   [] = T_1Day_10Days_Unp (a,e,i,OM,om,f,muE,om_E,t0,T,RE,type)
%
% INPUT:
...
%
% OUTPUT:
%   Figure with the unperturbed ground track for each time duration. 
%
% CONTRIBUTORS:
%   Andrea Bersani
%   Giovanni Chiarolla
        ...
        for l = 1:3
            ...
            switch l
                case 1
                    ...
                    plot(lon(end),lat(end),'sm','linewidth',2,'markersize',12)
                case 2
