function [] = T_1Day_10Days_Sec (a,e,i,OM,om,f,muE,om_E,t0,T,m,k,J2,RE,type)

% T_1Day_10Days_Sec.m - plot secular ground track for each time duration. 
%
% PROTOTYPE:
%   [] = T_1Day_10Days_Sec (a,e,i,OM,om,f,muE,om_E,t0,T,m,k,J2,RE,type)
%
% INPUT:
...
%
% OUTPUT:
%   Figure with the secular ground track for each time duration. 
%
% CONTRIBUTORS:
%   Andrea Bersani
%   Giovanni Chiarolla
